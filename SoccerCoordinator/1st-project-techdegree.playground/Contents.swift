...
func sendLetter2Guardian (teamName: [[String:String]]) {
    ...
    for player in teamName {
        if let playerName = player["name"],
            ...
            print("""
                Dear \(guardianName),\n
                    On behalf of \(teamName), we inform you about the selection of the player, \(playerName), to practice with the team on \(practiceTime)\n
                    For further information please contact the \(teamName) Adminstrator
                \n
                Yours faithfully,\n\n\n\n
                """)
